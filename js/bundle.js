...
var getAddr = function getAddr() {
  ...
  var addr = address.val().split(' ').join('+'),
      cty = city.val().split(' ').join('+'),
      ste = state1.val().split(' ').join('+');

  var geoquery = baseurl + 'address=' + addr + ',+' + cty + ',+' + ste + '&key=' + apikey;
...
},{"base64-js":2,"buffer":3,"ieee754":4,"pBGvAp":7}],4:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/../node_modules/moment/moment.js","/../node_modules/moment")
...
}).call(this,require("pBGvAp"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/../node_modules/point-in-polygon/index.js","/../node_modules/point-in-polygon")
},{"buffer":3,"pBGvAp":7}],7:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
